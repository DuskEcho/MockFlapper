...
let pages = [
    (<div>
        ...
        <h3 className={"page-title"}>About your product</h3>
            <hr/>
        </div>
        <div className={"form-row"}>
            <label htmlFor={"product-descript"} className={"label"}>What needs moving?</label>
            <input id={"product-descript"} placeholder={"Short description"} className={"form form-control wrap-text"} type={"text"}/>
        ...
        <div className={"form-row"}>
            <label htmlFor={"package-width package-length package-height"} className={"label"}>How big is it in inches?</label>
...
function App() {
    return (
        <div className="App">
            <nav className={"navbar navbar-light bg-light"} style={{"margin-bottom": "20px"}}>
